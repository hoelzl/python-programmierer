...
# # Reguläre Ausdrücke
#
# Reguläre Ausdrücke stellen "Muster" dar, mit denen in Strings gesucht und
# ersetzt werden kann:
# - `x..x`: zwei Vorkommen von `x`, die durch (genau) zwei beliebige andere
...
# - `*`: Der vorhergehende Ausdruck (ein Zeichen oder eine geklammerte Gruppe
#   von Zeichn) kann beliebig oft (auch 0-mal) wiederholt werden.
