...
#
#  Das `MessageQueue` Beispiel zeigt, wie ein Programm aus mehreren Modulen bestehen kann.
...
# - `c` kann ein Modul oder ein Package sein
# - `d` kann ein Modul, ein Package oder ein Name (d.h. eine Variable, eine 
# Funktion, eine Klasse, usw.) sein
